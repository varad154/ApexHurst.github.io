...
<header>
    <img src="images\Hurst expo logo1.png" alt="ApexHurst GFX_logo">
    ...
    <nav>
        <ul>
            ...
            <li><a href="plans.html">Plans</a></li> <!-- Link to plans page -->
            <li><a href="monia.html">Testimonials</a></li>
            <li><a href="contact.html">Contact</a></li>
            <li><a href="https://t.me/gfx_academy"> <span>Free</span> Signal </a></li>
...
<footer class="footer">
    <div class="footer-container">
        ...
        <div class="newsletter">
            <h2>📩 Stay Updated with <span>ApexHurst</span> Forex</h2>
        ...
        <div class="footer-links">
            <div class="footer-column">
                <h3>🌍 ApexHurst Forex Academy</h3>
                <ul>
                    <li><a href="about.html">About</a></li>
                    <li><a href="#">Mentorship Plans</a></li>
                    <li><a href="#">Blog</a></li>
                    <li><a href="FAQs.html">FAQs</a></li>
                    <li><a href="#">Access Learning Dashboard</a></li>
            ...
            <div class="footer-column">
                 ...
                 <p>ApexHurst Exponent<br /> 
                    Corporate office: 3rd floor, Office No 5, plot No 3a, sec No 28, PCNT, Nigdi, Pune, Maharashtra 411044(IN)<br />
                     <a href="mailto:info@hurstexponent.in">📩 info@hurstexponent.in </a><br />
                     <a href="tel:+919960887001">📞 +919960887001</a>
                </p>
            </div>
            <div class="footer-column">
                <h3>📲 Follow Us</h3>
                <div class="social-icons">
                    <a href="https://t.me/gfx_academy"><i class="fab fa-telegram"></i></a>
        ...
        <div class="footer-bottom">
            ...
            <p>© 2025 ApexHurst Exponent Private Limited. All Rights Reserved.</p>
        </div>
